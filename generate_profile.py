...
INFO = [
    ("__header__", "shreyas patange", ""),
    ("__rule__", "", ""),
    ("Role",     "SDE-I @ 169PI AI  ·  building Alpie.ai", "val"),
    ("Mentor",   "MERN Stack @ Tutedude", "val"),
    ("Edu",      "B.E. Computer Science, SPPU  ·  2025", "val"),
    ("Focus",    "Frontend Engineering  ·  Full-Stack  ·  Real-time AI", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
    ("Frontend", "React · Next.js · JavaScript", "val"),
    ("Backend",  "Node.js · Express · REST APIs", "val"),
    ("AI",       "Streaming Chat · Multi-provider Auth · Email Agents", "val"),
    ("Data",     "MongoDB · S3", "val"),
    ("__blank__", "", ""),
    ("__section__", "~/projects", ""),
    ("Alpie.ai", "Real-time AI systems · streaming chat, auth, uploads", "warn"),
    ("",         "100x load perf via S3, lazy load, virtualization", "muted"),
    ("Bulk Mailer", "Node/Express/EJS · SSE live status · dark terminal UI", "warn"),
    ("Portfolio", "Three.js particles · GSAP scroll · glassmorphism", "warn"),
    ("__blank__", "", ""),
    ("__section__", "~/highlights", ""),
    ("__stats__", "", ""),
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("Web",      "shreyas009portfolio-v2.vercel.app", "accent"),
    ("In",       "linkedin.com/in/shreyas-tungar-23878a252", "accent"),
    ("Mail",     "shreyastungar762@gmail.com", "accent"),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to Frontend / Full-Stack roles</tspan>'
